...
You can also find a running example here: https://bun.cytric.nl/Fishgems also its a bit outdated but its easily updateable, did you make a accurate version? you can message me on hello@semmy.io and I will host it for free.

## how to run it
literally just open `index.html`.  
no npm install, no build steps, no server. just pure vanilla JS and some CSS.
